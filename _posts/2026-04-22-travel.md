...
***Over the years, I’ve explored 15 countries across mostly Europe and Asia, sometimes solo, sometimes with friends, and sometimes with complete strangers. In this post, I’m highlighting the moments and insights from these travels that have impacted me the most!***
<!--more-->
...
After coming back home, I let go of things that I didn't need anymore, left my previous gym for a new better gym, decorated my house, got new clothes and made new friends. It is great to see these changes that come from solo travel.
</div>

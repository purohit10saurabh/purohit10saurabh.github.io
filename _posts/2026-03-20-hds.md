...
Machine learning works in high dimensional spaces. These spaces exhibit many counterintuitive phenomena known as the <a href="https://en.wikipedia.org/wiki/Curse_of_dimensionality" target="_blank">Curse of Dimensionality</a>. In this post, we explore a paradox that arises in high dimensions. Let's dive in!
<!--more-->

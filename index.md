...
<section class="section">
  ...
  <ul class="highlights">
    ...
    <li><span class="year">2018</span>At <strong><a href="https://www.goldmansachs.com/">Goldman Sachs</a></strong>, used machine learning techniques to improve the R-squared error of a regression based production model drastically, having an impact of millions of dollars in revenue.</li>
  </ul>
</section>
